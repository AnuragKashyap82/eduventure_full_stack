...
import '../user_all_applied_books.dart';

class AppliedManagementScreen extends StatefulWidget {
  const AppliedManagementScreen({Key? key}) : super(key: key);

  @override
  State<AppliedManagementScreen> createState() => _AppliedManagementScreenState();
}

class _AppliedManagementScreenState extends State<AppliedManagementScreen> {
      ...
      body: Column(
        ...
        children: [
            ...
            child: SizedBox(
              ...
              child: Center(
                child: TextField(
                  ...
                  onChanged: (value) {
                    setState(() {
                      issueBookControllerController.searchUserApplied(value);
                    });
                  },
          ...
          Obx(() {
            ...
            if (issueBookControllerController.allAppliedBooks.isEmpty) {
              return Center(
                child: Text(
                  "No Applied Books",
                  style: TextStyle(
            ...
            return ListView.builder(
              itemCount: _searchKeyController.text.isNotEmpty
                  ...
                  : issueBookControllerController.allAppliedBooks.length,
              shrinkWrap: true,
              physics: BouncingScrollPhysics(),
              itemBuilder: (_, index) {
                final appliedBooks = _searchKeyController.text.isNotEmpty
                    ? issueBookControllerController.searchResults[index]
                    : issueBookControllerController.allAppliedBooks[index];
                return Container(
                  child: GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => UserAllAppliedBooksScreen(
                            issueBookModel: appliedBooks,
                          ),
                        ),
                      );
                    },
